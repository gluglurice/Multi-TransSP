...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, d_model=mc.d_model, nhead=mc.nhead, num_layers=mc.num_layers,
                 num_patches=None, fusion_feature_channel=None):
    ...
    def forward(self, x):
        ...
        additional_tokens = repeat(self.additional_token, '() n d -> b n d', b=mc.batch_size)
...
if __name__ == '__main__':
    ...
    input_feature = torch.rand(1, 524, 11, 11, dtype=torch.float32).to(mc.device)
